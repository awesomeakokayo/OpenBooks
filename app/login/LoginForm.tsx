    ...
    <form onSubmit={onSubmit} className="flex flex-col gap-5">
      ...
      <label className="flex flex-col gap-2">
        <div className="flex items-center justify-between">
          ...
          <a href="#" onClick={(e) => e.preventDefault()} className="text-xs font-medium text-[#918A91] hover:text-[#503047]">
            Forgot?
          </a>
        </div>
        <span className="relative flex">
      ...
      >
        {loading ? (
          ...
          <>
            Sign in <ArrowRight size={17} strokeWidth={2.2} />
          </>
        )}
      </button>
      ...
      <div className="flex items-center gap-3 py-1">
        ...
        <span className="text-xs font-medium tracking-[0.04em] text-[#918A91]">or continue with</span>
        <span className="h-px flex-1 bg-[#E5E3DF]" />
      </div>
      ...
      <div className="grid gap-2.5 sm:grid-cols-2">
        <button
          ...
          className="inline-flex h-12 items-center justify-center gap-2 rounded-xl border border-[#E5E3DF] bg-white px-4 text-sm font-semibold text-[#503047] hover:bg-[#F8F8F6]"
        >
