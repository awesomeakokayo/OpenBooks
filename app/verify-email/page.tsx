    ...
    <main className="min-h-screen bg-[#F8F8F6] text-[#503047]">
      ...
      <section className="flex min-h-[calc(100vh-88px)] items-center justify-center px-5 py-12">
        <div className="w-full max-w-[520px] rounded-[32px] border border-[#E5E3DF] bg-white p-8 text-center shadow-[0_25px_70px_rgba(80,48,71,0.10)] sm:p-10">
          {success ? (
            <>
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#D0E3C4] text-[#36563A]">
              ...
              <p className="mx-auto mt-4 max-w-[38ch] text-sm leading-6 text-[#6F6670]">
                Your OpenBooks account is ready. Sign in to continue setting up your business.
              </p>
            ...
            <>
              ...
              <Link href="/login" className="mt-8 inline-flex h-12 items-center justify-center rounded-2xl bg-[#503047] px-6 text-sm font-semibold text-white">Back to sign in</Link>
            </>
          ) : rateLimited ? (
            <>
            ...
            <>
              ...
              <p className="mx-auto mt-4 max-w-[40ch] text-sm leading-6 text-[#6F6670]">We sent a verification link to the email you used to create your account. Open it to continue.</p>
              <p className="mt-6 text-xs leading-5 text-[#918A91]">Didn't receive it? Check spam or promotions, then use the resend option from registration.</p>
              <Link href="/register" className="mt-8 inline-flex h-12 items-center justify-center rounded-2xl border border-[#E5E3DF] bg-white px-6 text-sm font-semibold text-[#503047] hover:bg-[#F8F8F6]">Back to registration</Link>
            </>
          )}
        </div>
      </section>
