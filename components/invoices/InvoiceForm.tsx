  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-col gap-6">
      <div className="flex flex-col gap-1.5">
        ...
        <select name="customerId" required className="flex h-[48px] w-full rounded-[12px] border border-plum/12 bg-white px-4 text-sm text-plum">
        ...
        {customers.length === 0 && <p className="text-xs text-terracotta">No customers — add one first at Customers → Add.</p>}
      </div>
